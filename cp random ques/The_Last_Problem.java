...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    public static void main(String[] args){
         ...
         while(t-->0){
            ...
            while(a!=x2||b!=y2){
                ...
                if(getval(a+1,b)>getval(a,b+1)){
                    // sb.append(getval(a+1,b)+"\n");
                    oval+=getval(a+1,b);
                    a++;
                }else if(b+1<=y2&&getval(a+1,b)<getval(a,b+1)){
                    // sb.append(getval(a,b+1)+"\n");
                    b++;
                } 
            }
                // sb.append(a+"--"+b+" ");
    ...
    public static int getval(int x,int y){
        return (((x*(x+1))/2)+(x*(y-1))+(((y-2)*(y-1))/2));
    }
}
